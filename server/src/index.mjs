...
const providerDefaults = [
  ...
  ['minimax','MiniMax','openai-compatible','https://api.minimax.io/v1',['MiniMax-Text-01'],false],
  ['custom','Custom / Local','openai-compatible',process.env.CUSTOM_BASE_URL || 'http://host.docker.internal:11434/v1',['local-model'],false]
